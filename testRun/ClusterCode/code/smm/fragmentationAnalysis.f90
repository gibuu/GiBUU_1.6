...
contains
  ...
  ! 
  !*************************************************************************
  subroutine printFragmentVector(isu,numEnsemples,FragmentVector)
    use typeDefinitions, only : cluster
    implicit none

    integer, intent(in) :: isu,numEnsemples
...
50  format(i4,1x,i4,1x,i4,1x,i4,1x,3(1x,f8.3),3(1x,f8.3),1x,i4,1x,i4)
  ...
  subroutine detailedHypAnalysis(is,in,SubEvents,NumEnsemples,SMM_Events, & 
       & FragmentVector,particleVector,printflag,impactParameter)
  ...
  ! 
  !*************************************************************************
  subroutine producedParticles(SubEvents,NumEnsemples,SMM_Events, & 
    ...
    !yields:
    real, dimension(1:ipart), SAVE :: Yield_mes !total production yields of mesons
    real, dimension(1:ipart), SAVE :: Yield_bar !total production yields of bayrons
...
!      Norm_IMF(:) = 0.0
  ...
  subroutine rapidityDistribution(SubEvents,NumEnsemples,SMM_Events, & 
       & irun,FragmentVector,ParticleVector,printflag,impactParameter)
...
100    format(50e12.4)
  ...
  subroutine spectatorFragmentation(SubEvents,NumEnsemples,SMM_Events,irun,& 
       & FragmentVector,ParticleVector,printflag,Ztarget,impactParameter)
...
!    real, dimension(-nrap:nrap,1:ipart), SAVE :: dndyspL,dndyspLL,dndyspP
    ...
    integer :: i,j,ibin,ibiny,ibins,aa,zz,pID,ibiny2,ibinFra
...
108    format('# (4-7)H(L,S)    = ',8e15.6)
109    format('# (5-10)He(L,S)  = ',12e15.6)
110    format(50e12.4)
111    format(50e12.4)
...
!         dndyspLL(ibiny2,icount) = dndyspLL(ibiny,icount) +  NormSMM                
  ...
  subroutine velocityDistr_Charms(SubEvents,NumEnsemples,SMM_Events,& 
    ...
    real    :: k0f,k0flrf,k3f,yb,ySRF,betaSRF,ySpect
