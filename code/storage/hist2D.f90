...
1000 FORMAT(1X,' ',1P,2E12.4,4E12.4)   
  ...
  subroutine WriteHist2D_Gnuplot_Bspline(H,iFile,add,mul, iColumn,nPoints,DoAve,MaxVal)
    ...
    do iBin1=1,iBinMax(1)*nPP
       ...
       ZZx = 0.
       call Bsplint2(xx,ZZx, xVal, zVal(0), Indx,Prefx, .false.)
       ...
       do iBin2=1,iBinMax(2)*nPP
          ...
          if (writeZ) then
             ...
             do i=-1,2
                ZZy = ratio(Indx(i),:)
                call Bsplint2(yy,ZZy, yVal, ZZx(Indx(i)), Indy,Prefy, flag)
                flag = .true.
             enddo
             call Bsplint2(xx,ZZx, xVal, zVal(0), Indx,Prefx, .true.)
          endif
          ...
          if (present(iColumn)) then
             ...
             do i=-1,2
                ...
                flag = .true.
             enddo
             call Bsplint2(xx,ZZx, xVal, zVal(iC), Indx,Prefx, .true.)
             if (writeZ) then
