...
module thermoDynamics
  ...
  Public :: updateTemperature, temperatureAt, cleanUp
...
!      real, dimension(0:3) :: p !momentum
  ...
  real function tempe (p2av, rho)
    ...
    real, intent(in) :: p2av ! <p**2>
    real, intent(in) :: rho  ! baryon density

    integer :: index_rho,index_p2av
    real, parameter :: delta_rho  = 0.1      ! stepsize for rho in units of rho0
    real, parameter :: delta_p2av = 0.01     ! stepsize for <p**2>
    integer, parameter :: maxIndex_rho  = 50
    integer, parameter :: maxIndex_p2av = 900
  ...
  contains
    ...
    subroutine initTempe
      ...
      integer :: i,j
      real, parameter :: delta_temperature = 0.0002  ! exactness of temperature
      real :: p2average ! <p**2>
