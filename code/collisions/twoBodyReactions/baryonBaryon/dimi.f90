...
contains
  ...
  !*************************************************************************
  !****s* dimi/massNN_NDelta
  ! NAME
  ! subroutine massNN_NDelta (srts, massDelta)
  ! PURPOSE
  ...
  end subroutine massNN_NDelta


  !*************************************************************************
  !****s* dimi/dimiSigma
  ! NAME
  ! subroutine dimiSigma(sigma,srts,massDelta)
  ! PURPOSE
  ...
  end subroutine dimiSigma


  !*************************************************************************
  !****s* dimi/dimiIntegrated
  ! NAME
  ! subroutine dimiIntegrated (dsdm_Integrated, srts)
  ! PURPOSE
