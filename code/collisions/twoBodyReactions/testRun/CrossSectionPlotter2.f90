...
program CrossSectionPlotter2
  ...
  use idTable, only: nucleon, pion, isBaryon
...
evtloop: do j=1,Nevents  ! event loop to produce final states
     ...
     write(23,'(9F12.4)') absmom(pair(2)), kineticEnergy(pair(2)), srts, sigTot, sigma_out_excl(0:3), rHiEnergy
     flush(23)
     ...
     write(27,'(11F12.4)') absmom(pair(2)), kineticEnergy(pair(2)), srts, sigTot, sigma_prongs(0:6)
     flush(27)
...
contains
  ...
  subroutine readInput
    ...
    NAMELIST /Plotter2/ id1,id2,q1,q2,anti1,anti2,id_out,q_out,Nevents,srts_max,dp
