...
contains
  ...
  !*************************************************************************
  subroutine DoColl_BaB (inPart, outPart, flagOK, sqrtS, pcm, beta)
    use particleDefinition, only: particle, IsElastic
    ...
    use CollGetLeading, only: SplitBaryon, GetLeading_PY
    ...
    real, dimension(4,3) :: impuls ! three-momenta of outgoing quarks
...
!      Phase space redistribution of the outgoing quark momenta:
       ...
       e(1)=sqrt(mass(1)**2+dot_product(impuls(1,1:3),impuls(1,1:3)))
       e(2)=sqrt(mass(2)**2+dot_product(impuls(2,1:3),impuls(2,1:3)))
       e(4)=sqrt(mass(4)**2+dot_product(impuls(4,1:3),impuls(4,1:3)))
  
       x1=2.*e(1)/sqrts
       x2=2.*e(2)/sqrts
       x4=2.*e(4)/sqrts
  
       x12=2.*(e(1)*e(2)-dot_product(impuls(1,1:3),impuls(2,1:3)))/sqrts**2
       x14=2.*(e(1)*e(4)-dot_product(impuls(1,1:3),impuls(4,1:3)))/sqrts**2
