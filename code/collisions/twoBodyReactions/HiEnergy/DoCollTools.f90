...
!!$  !*************************************************************************
!!$  !****s* CollTools/ConvertInPart
!!$  ! NAME
!!$  ! subroutine ConvertInPart(ID,IDc)
!!$  ! PURPOSE
!!$  ! reduce variety of incoming mesons to some simpler manyfold
!!$  !*************************************************************************
!!$  subroutine ConvertInPart(ID,IDc)
!!$    IMPLICIT NONE
!!$    
...
!!$       IDc = 101         ! sigma -> pi
!!$    case (106)
!!$       IDc = 102         ! etaprime -> eta
!!$    end select
!!$    
!!$  end subroutine ConvertInPart


  !*************************************************************************
  !****s* CollTools/ConvertInPartPythia
  ! NAME
  ! subroutine ConvertInPartPythia(ID,IDc)
  ! PURPOSE
  ! Reduce variety of incoming mesons to some simpler manyfold
  ! (special for Pythia).
  !*************************************************************************
  ...
  ! whats about storing this information in an array???
  ! should be faster !!!
  ! cf. BUUtoKF etc.!!!
  ...
  end subroutine ConvertInPartPythia


  !*************************************************************************
  !****s* CollTools/ConvertInPartFritiof
  ! NAME
  ! subroutine ConvertInPartPythia(ID,IDc)
  ! PURPOSE
  ! Reduce variety of incoming mesons to some simpler manyfold
  ! (special for Fritiof).
  !*************************************************************************
  subroutine ConvertInPartFritiof(ID,IDc)
...
!          write(*,*) 'ConvertInPartFritiof: no charm! ',ID
  ...
  end subroutine ConvertInPartFritiof


  !*************************************************************************
  !****s* CollTools/ReduceCharge
  ! NAME
  ! subroutine ReduceCharge(ID,IZ,IZc)
  ! PURPOSE
  ! Reduce charge of incoming particle, if it is N, N* or Delta
