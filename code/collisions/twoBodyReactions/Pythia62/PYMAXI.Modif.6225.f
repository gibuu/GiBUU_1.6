...
c=================================================================
c This is a copy of the original PYTHIA-PYMAXI (v6.225)
c output of some "warnings" (FORMAT 5100,5300) 
c commented out
c
c make sure, that the original PYMAXI is not linked
