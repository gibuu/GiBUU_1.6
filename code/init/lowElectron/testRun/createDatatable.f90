program createDataTable
  ...
  real :: W,Q2,eps,XSp,XS,nu,XS2,XS3
  integer :: i,j,iq,iiq
...
!  do j=22,45
     ...
     !  do i=190,200,2
        ...
        write(121,'(4f12.4,1P,e12.4)') W,nu,Q2,eps, XSp 

        call CalcXS_MC(inPart,W,Q2,eps,nMC, XS_s,rMC)
        write(122,'(4f12.4,1P,3e12.4,0P,f12.4,1P,10e12.4)') Q2,nu,W,eps, XSp, fT, XS_s(0), rMC, XS_s(1:3)
        write(6,'(A,4f12.4,1P,3e12.4,0P,f12.4,1P,10e12.4)') '==>',Q2,nu,W,eps, XSp, fT, XS_s(0), rMC, XS_s(1:3)
