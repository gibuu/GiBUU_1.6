...
contains
  ...
  contains
    ...
    function j_pionPole(charge_out,pion_charge_out) result (matrix)
      ...
      use constants, only : g_A, f_pi
      use minkowski, only : slashed, SP, ii
    ...
    function j_pionInFlight(charge_out,pion_charge_out) result (matrix)
      ...
      use constants, only : g_A, f_pi, mN, mPi
      use minkowski, only : SP, ii, gamma5
    ...
    function vertex_NNpi(ppi) result(matrix)
      ...
      use constants, only : f_pi, g_A
      use minkowski, only : slashed5, ii
