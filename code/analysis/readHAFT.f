c******************************************************************************
c This file contains the orignal HAFT code version 2.0, as obtained from
c http://www-hades.gsi.de, with minor GiBUU-specific modifications
c (Janus Weil, 20/04/2011).
c******************************************************************************
c
...
c
      ...
      theta = twopi*rn()
      sampleGauss = mean + sigma*cos(theta)*sqrt(-2.*log(rn()))
      return
      end
c
c
