...
module neutrinoAnalysis
  ...
  ! PURPOSE
  ! do calorimetric enregy-transfer and neutrino-energy reconstruction
  ...
  integer, parameter ::  max_SpeEvent=16
  ...
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dE_hists,dE_hists_QE,dE_hists_Delta,dE_hists_highRes,&
       & dE_hists_gen0,dE_hists_1piBG,dE_hists_2piBG,dE_hists_DIS,dE_hists_2p2h
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dE_hists_Multi,dE_hists_QE_Multi,dE_hists_Delta_Multi,&
       & dE_hists_highRes_Multi,dE_hists_gen0_Multi,dE_hists_1piBG_Multi,dE_hists_2piBG_Multi,dE_hists_DIS_Multi, &
       & dE_hists_2p2h_Multi
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dE_hists_1X,dE_hists_QE_1X,dE_hists_Delta_1X,&
       & dE_hists_highRes_1X,dE_hists_gen0_1X,dE_hists_1piBG_1X,dE_hists_2piBG_1X,dE_hists_DIS_1X, dE_hists_2p2h_1X
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dE_hists_2X,dE_hists_QE_2X,dE_hists_Delta_2X,&
       & dE_hists_highRes_2X,dE_hists_gen0_2X,dE_hists_1piBG_2X,dE_hists_2piBG_2X,dE_hists_DIS_2X,dE_hists_2p2h_2X

  ! used for ZeroPion_analysis=.true.  for kinetic energy distributions of nucleons in events with 0 pions
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dE_hists_0pions, dE_hists_QE_0pions, dE_hists_Delta_0pions, &
       dE_hists_highRes_0pions, dE_hists_2p2h_0pions, dE_hists_1piBG_0pions, dE_hists_2piBG_0pions, dE_hists_DIS_0pions
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dE_hists_Multi_0pions, dE_hists_QE_Multi_0pions, &
       & dE_hists_Delta_Multi_0pions, dE_hists_highRes_Multi_0pions, dE_hists_2p2h_Multi_0pions, &
       & dE_hists_1piBG_Multi_0pions, dE_hists_2piBG_Multi_0pions, dE_hists_DIS_Multi_0pions
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dE_hists_1X_0pions, dE_hists_QE_1X_0pions, dE_hists_Delta_1X_0pions, &
       & dE_hists_highRes_1X_0pions, dE_hists_2p2h_1X_0pions, dE_hists_1piBG_1x_0pions, dE_hists_2piBG_1x_0pions, &
       & dE_hists_DIS_1x_0pions
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dE_hists_2X_0pions, dE_hists_QE_2X_0pions, dE_hists_Delta_2X_0pions, &
       dE_hists_highRes_2X_0pions, dE_hists_2p2h_2X_0pions, dE_hists_1piBG_2x_0pions, dE_hists_2piBG_2x_0pions, &
       & dE_hists_DIS_2x_0pions
  ...
  type(histogram), dimension(0:max_Hist), save :: dSigdNu_hist, dSigdEhad_hist,  dSigdEnu, dSigdEnurestored


  ! used for specificEvent_analysis=.true.
  type(histogram),save, dimension(1:max_SpeEvent,0:max_Hist) :: dEnu_hist, dElepton_hist,     dcoslepton_hist,     dQ2lepton_hist



  type(histogram),save,dimension(1:numStableParts,-2:2) :: dTheta_hists,dPhi_hists,dTheta_hists_QE,dPhi_hists_QE, &
       & dTheta_hists_Delta,dPhi_hists_Delta,dTheta_hists_highRes,dPhi_hists_highRes,dTheta_hists_gen0,dPhi_hists_gen0, &
       & dTheta_hists_1piBG,dPhi_hists_1piBG,dTheta_hists_2piBG,dPhi_hists_2piBG

  type(histogram2D),save,dimension(1:numStableParts,-2:2) :: dOmega_hists,dOmega_hists_QE,dOmega_hists_Delta,dOmega_hists_highRes, &
       & dOmega_hists_gen0,dOmega_hists_1piBG,dOmega_hists_2piBG

  type(histogram),save,dimension(1:numStableParts,-2:2) :: dEcostheta_hists,dEcostheta_hists_QE,dEcostheta_hists_Delta, &
       & dEcostheta_hists_highRes, dEcostheta_hists_gen0,dEcostheta_hists_1piBG,dEcostheta_hists_2piBG,dEcostheta_hists_DIS
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dEcostheta_hists_MULTI,dEcostheta_hists_QE_MULTI, &
       & dEcostheta_hists_Delta_MULTI, dEcostheta_hists_highRes_MULTI, dEcostheta_hists_gen0_MULTI, &
       & dEcostheta_hists_1piBG_MULTI,dEcostheta_hists_2piBG_MULTI,dEcostheta_hists_DIS_MULTI
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dcostheta_hists,dcostheta_hists_QE,dcostheta_hists_Delta, &
       & dcostheta_hists_highRes, dcostheta_hists_gen0,dcostheta_hists_1piBG,dcostheta_hists_2piBG,dcostheta_hists_DIS
  type(histogram),save,dimension(1:numStableParts,-2:2) :: dcostheta_hists_MULTI,dcostheta_hists_QE_MULTI, &
...
contains
  ...
  ! NONE
  ! PURPOSE
  ! This subroutine reads out the namelist "neutrinoAnalysis".
  ...
  subroutine readinput
    ...
    ! * EnergyDetectionThreshold_lepton
    ! * outputEvents
    ...
    NAMELIST /neutrinoAnalysis/ detailed_diff_output, include_W_dist, &
                                ...
                                kineticEnergyDetectionThreshold_chargedpion, &
                                kineticEnergyDetectionThreshold_neutralpion, &
                                inclusiveAnalysis, Fissum_analysis, ZeroPion_analysis, calorimetric_analysis, &
                                radialScale, reconstruct_neutrino_energy, &
                                EnergyDetectionThreshold_lepton, outputEvents, specificEvent_analysis
    ...
    NAMELIST /nl_specificEvent/ no_pi, p_Xn_no_pi, piplus, pi0, pi0_MULTI, &
         ...
         binsizeQ2, binsizeEnu, maxQ2, maxEnu
    ...
    NAMELIST /detailed_diff/ ekinMin,ekinMax, dEkin, &
         forpion, foreta, forkaon, forkaonBar, fornucleon, forLambda, &
         forSigmaResonance
  ...
  subroutine neutrino_Analyze(Particles,finalFlag,num_runs_sameEnergy)
    ...
    use expNeutrinofluxes, only : MiniBooNE_recQs, MiniBooNE_recQs_Delta, MiniBooNE_recEnergy, MiniBooNE_recEnergy_Delta, &
                                   & K2K_recEnergy, K2K_recQs
    ...
    type(tAnaEvent), Allocatable, dimension(:) :: events,events_QE,events_Delta,events_highRES,events_1piBG, &
         & events_DIS,events_2p2h, events_2piBG
    type(tAnaEvent), Allocatable, dimension(:) :: events_gen0,events_gen1,events_gen2,events_gen3ormore ! A list of all events
    ...
    real, dimension(1:100,1:2),save :: sigma, sigma_QE,sigma_Delta,sigma_highRES,sigma_1piBG,sigma_2piBG,sigma_DIS,sigma_2p2h
    real, dimension(1:100,1:2),save :: sigma_gen0,sigma_gen1,sigma_gen2,sigma_gen3ormore
    ...
    real, dimension(1:100,1:2),save :: sigma_0pions, sigma_QE_0pions,sigma_Delta_0pions,sigma_highRES_0pions, sigma_1piBG_0pions, &
    ...
    real, dimension(-1:1) ::            tsigmanucleon=0.     ! in DIS antiproton are also possible in final states
    real,dimension(-1:1,0:200) ::       tksigmanucleon=0.    ! in DIS antiproton are also possible in final states

    real,dimension(-1:1),save ::       sum_tsigmapion=0.
    real,dimension(-1:1),save ::        sum_tsigmanucleon=0. ! in DIS antiproton are also possible in final states
    real,dimension(-1:1,0:200),save :: sum_tksigmapion=0.
    real,dimension(-1:1,0:200),save ::  sum_tksigmanucleon=0.  ! in DIS antiproton are also possible in final states
    ...
    integer,dimension(-1:1,0:max_generation) :: numberofnucleons_out  ! in DIS antiproton are also possible in final states
    ...
    type(histogram),   save ::  H_Q2_real(1:max_speEvent,0:max_Hist), H_Q2_rec(1:max_speEvent,0:max_Hist)
    type(histogram2D), save :: H_Q2_rec_versus_real(1:max_speEvent,0:max_Hist)
    type(histogram),   save :: H_enu_real(1:max_speEvent,0:max_Hist), H_enu_rec(1:max_speEvent,0:max_Hist)
    ...
    type(histogram),   save :: Oscmumu_enu_real(1:max_speEvent,0:max_Hist),  Oscmumu_enu_rec(1:max_speEvent,0:max_Hist)
    type(histogram),   save :: Oscmuemax_enu_real(1:max_speEvent,0:max_Hist),  Oscmuemax_enu_rec(1:max_speEvent,0:max_Hist)
    type(histogram),   save :: Oscmue_enu_real(1:max_speEvent,0:max_Hist),  Oscmue_enu_rec(1:max_speEvent,0:max_Hist)
    type(histogram),   save :: Oscmueantimax_enu_real(1:max_speEvent,0:max_Hist),  Oscmueantimax_enu_rec(1:max_speEvent,0:max_Hist)
    ...
    if(initflag) then
       ...
       if (fornucleon) printFlags(7)=.true. ! nucleon
       if (forLambda) printFlags(8)=.true. ! Lambda
       if (forSigmaResonance) printFlags(9)=.true. ! Sigma
       ...
       ! * #2-#99: see description in AnaEvent.f90, subroutine event_sigma
       ...
       write(10,*)'# next 100 columns: error'
       ...
       ! PURPOSE
       ! The same as neutrino_total_Xsection_multiplicities.dat
       ! but for 1piBG events (=the first interaction was production of
       ! 1-pion final state)
       !**********************************************************************
       if(include1pi) then
       ...
       write(10,*)'# Total xsec for outgoing pions and nucleons: each pion/nucleon contribute to the xsec'
       write(10,*)'# 1: raiseVariable  2: sigma(pi-)    3:pi0    4:pi+   5:antiproton  6:neutron, 7:proton'
       close(10)
       ...
       write(10,*)'# order of entries: 1:raise variable  2:ekin, 3:sig pi-, 4:sig pi0, 5:sig pi+, 6:sig neut, 7:sig prot'
       close(10)
       ...
       write(10,*) '#1:raiseFlagVariable, #2:p_tot, #3:p_out, #4:p_out_gen0, #5:p_out_gen1, #6:p_out_gen2, #7:p_out_gen3ormore,&
            & #8:n_tot, #9:n_out, #10:n_out_gen0, #11:n_out_gen1 ,#12:n_out_gen2,#13:n_out_gen3ormore, &
            & #14:barp_tot, #15:barp_out, #16:barp_out_gen0, #17:barp_out_gen1, #18:barp_out_gen2,#19:bar p_out_gen3ormore'
       close(10)
       ...
       if(ZeroPion_analysis) then
          Open(10,File='neutrino_0pions.dat')
          write(10,*)'# total Xsections for defined finalstates (see sigma_0pions.dat)'
          write(10,*)'# next 100 columns: error'
          write(10,*)'# order of Xsections as in sigma_0pions.dat'
          close(10)

          if(includeQE) then
          Open(10,File='neutrino_0pions_QE.dat')
          write(10,*)'# total Xsections for defined finalstates (see sigma_0pions.dat)'
          write(10,*)'# next 100 columns: error'
          write(10,*)'# order of Xsections as in sigma_0pions.dat'
          close(10)
          ...
          if(includeDELTA) then
          Open(10,File='neutrino_0pions_Delta.dat')
          write(10,*)'# total Xsections for defined finalstates (see sigma_0pions.dat)'
          write(10,*)'# next 100 columns: error'
          write(10,*)'# order of Xsections as in sigma_0pions.dat'
          close(10)
          ...
          if(includeRES) then
          Open(10,File='neutrino_0pions_highRES.dat')
          write(10,*)'# total Xsections for defined finalstates (see sigma_0pions.dat)'
          write(10,*)'# next 100 columns: error'
          write(10,*)'# order of Xsections as in sigma_0pions.dat'
          close(10)
          ...
          if(include1pi) then
          Open(10,File='neutrino_0pions_1piBG.dat')
          write(10,*)'# total Xsections for defined finalstates (see sigma_0pions.dat)'
          write(10,*)'# next 100 columns: error'
          write(10,*)'# order of Xsections as in sigma_0pions.dat'
          close(10)
          ...
          if(include2pi) then
          Open(10,File='neutrino_0pions_2piBG.dat')
          write(10,*)'# total Xsections for defined finalstates (see sigma_0pions.dat)'
          write(10,*)'# next 100 columns: error'
          write(10,*)'# order of Xsections as in sigma_0pions.dat'
          close(10)
          ...
          if(includeDIS) then
          Open(10,File='neutrino_0pions_DIS.dat')
          write(10,*)'# total Xsections for defined finalstates (see sigma_0pions.dat)'
          write(10,*)'# next 100 columns: error'
          write(10,*)'# order of Xsections as in sigma_0pions.dat'
          close(10)
          ...
          if(include2p2hQE .or. include2p2hDelta ) then
          Open(10,File='neutrino_0pions_2p2h.dat')
          write(10,*)'# total Xsections for defined finalstates (see sigma_0pions.dat)'
          write(10,*)'# next 100 columns: error'
          write(10,*)'# order of Xsections as in sigma_0pions.dat'
          close(10)
       ...
       if(reconstruct_neutrino_energy .and. specificEvent_Analysis) then
          ...
          if (.not.includeSpeEvent(m)) cycle
              ...
              ! Q2 reconstruction
              call CreateHist(H_Q2_real(m,iHist), 'true Q2 for a specific event',0.,maxQ2,binsizeQ2)
              call CreateHist(H_Q2_rec(m,iHist),  'reconstructed Q2 for a specific event',0.,maxQ2,binsizeQ2)
              call CreateHist2D(H_Q2_rec_versus_real(m,iHist), 'reconstructed Q2 versus real Q2 for a specific event', &
                                     &  (/0.,0./),(/maxQ2,maxQ2/),  (/binsizeQ2,binsizeQ2/))

              ! neutrino energy  reconstruction
              if (nuExp>0) call CreateHist(H_enu_real(m,iHist), 'true Enu for a specific event',0.,maxEnu,binsizeEnu)
              call CreateHist(H_enu_rec(m,iHist),  'reconstructed Enu for a specific event',0.,maxEnu,binsizeEnu)
              ...
              call CreateHist(Oscmuemax_enu_real(m,iHist), &
                                        & 'nu_e appearence versus true energy for delta_CP=pi/2',0.,maxEnu,binsizeEnu)
              call CreateHist(Oscmuemax_enu_rec(m,iHist),  &
                                        &  'nu_e appearence versus reconstructed energy for delta_CP=pi/2',0.,maxEnu,binsizeEnu)
              call CreateHist(Oscmue_enu_real(m,iHist),    'nu_e appearence versus true energy',0.,maxEnu,binsizeEnu)
              call CreateHist(Oscmue_enu_rec(m,iHist),     'nu_e appearence versus reconstructed energy',0.,maxEnu,binsizeEnu)
    ...
    if(numberOfCalls.eq.1) then
       initHists=.true.  ! Here we initialize the histograms
    else
       initHists=.false. ! Here we do not initialize the histograms
    end if
    ...
    write(*,'(a,F12.4)') 'kineticEnergyDetectionThreshold_nucleon ',kineticEnergyDetectionThreshold_nucleon
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    !total and kinetic energy differential cross section for pions and nuclei
    ...
    do i=lBound(Particles,dim=1),uBound(Particles,dim=1)
       do j=lBound(Particles,dim=2),uBound(Particles,dim=2)
          ...
          if(lep_mom(0).lt.EnergyDetectionThreshold_lepton) cycle
          ...
          case (pion)
             ...
             !total cross section
             tsigmapion(Particles(i,j)%charge)=tsigmapion(Particles(i,j)%charge)+Particles(i,j)%perweight

             !kinetic energy differential xsection
             tksigmapion(Particles(i,j)%charge,ntk)=&
                  &Particles(i,j)%perweight/dEkin+tksigmapion(Particles(i,j)%charge,ntk)
          ...
          case (nucleon)
             ...
             numberofnucleons_out(Particles(i,j)%charge,generation)=numberofnucleons_out(Particles(i,j)%charge,generation)+1
             ...
             tksigmanucleon(Particles(i,j)%charge,ntk)=&
                  &Particles(i,j)%perweight/dEkin+tksigmanucleon(Particles(i,j)%charge,ntk)
    ...
    write(10,'(10g13.5)') raiseFlagVariable, sum_tsigmapion/real(numberofcalls), sum_tsigmanucleon/real(numberofcalls)
    close(10)
    ...
    do i=0,200
       write(11,'(10g13.5)')raiseFlagVariable,(float(i)+0.5)*dEkin,sum_tksigmapion(-1,i)/real(numberofcalls),  &
    ...
    if(Fissum_analysis) then
       ...
       do i=0,200
          write(10,'(10g13.5)')raiseFlagVariable,(float(i)+0.5)*dEkin,sum_Emiss_Fissum(i)/real(numberofcalls)
       end do
       close(10)
    end if
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    !************************************************************************
    !now with more detailed information on multiplicities, generations and production process
    ...
    do i=firstEvents(1),firstEvents(2)
       ...
       ! lepton is added to event only if its energy exceeds the threshold
       if(lepton(i)%momentum(0).lt.EnergyDetectionThreshold_lepton) cycle
       ...
       case default
          write(*,*) 'strange prod_id -> STOP', prod_id
          stop
       end select
    ...
    do i=lBound(Particles,dim=1),uBound(Particles,dim=1)
       do j=lBound(Particles,dim=2),uBound(Particles,dim=2)
          ...
          if(bound(particles(i,j))) cycle
          if(below_threshold(particles(i,j))) cycle
          if(lepton(first)%momentum(0).lt.EnergyDetectionThreshold_lepton) cycle
          ...
          !the information, in which process the particle was produced (QE=1, Delta=2, highRES=3:31, BG=32:33)
          ...
          case default
             write(*,*) 'strange generation -> STOP', generation
             stop
          end select
    ...
    call event_sigma(events_highRES,sigma_highRES,initHists,numberOfCalls,identifier=raiseFlagVariable)
    ...
    call event_sigma(events_gen3ormore,sigma_gen3ormore,initHists,numberOfCalls,identifier=raiseFlagVariable)


    Open(10,File='neutrino_total_Xsection_multiplicities.dat',position='append')
    if(numberofcalls.ne.1) backspace(10)
    ...
    if (includeQE) then
       Open(10,File='neutrino_total_Xsection_multiplicities_QE.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_QE(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_QE(2:,2)-sigma_QE(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_QE(2:,1)
       end if
       close(10)
    end if

    if (includeDELTA) then
       Open(10,File='neutrino_total_Xsection_multiplicities_Delta.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_Delta(2:,1)/float(numberOfCalls),  &
               & sqrt(max(0.,((sigma_Delta(2:,2)-sigma_Delta(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_Delta(2:,1)
       end if
       close(10)
    end if

    if (includeRES) then
       Open(10,File='neutrino_total_Xsection_multiplicities_highRES.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_highRES(2:,1)/float(numberOfCalls),  &
               & sqrt(max(0.,((sigma_highRES(2:,2)-sigma_highRES(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_highRES(2:,1)
       end if
       close(10)
    end if

    if (include1pi) then
       Open(10,File='neutrino_total_Xsection_multiplicities_1piBG.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_1piBG(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_1piBG(2:,2)-sigma_1piBG(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_1piBG(2:,1)
       end if
       close(10)
    end if

    if (includeDIS) then
       Open(10,File='neutrino_total_Xsection_multiplicities_DIS.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_DIS(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_DIS(2:,2)-sigma_DIS(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_DIS(2:,1)
       end if
       close(10)
    end if

    if (include2p2hQE.or.include2p2hDelta) then
       Open(10,File='neutrino_total_Xsection_multiplicities_2p2h.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_2p2h(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_2p2h(2:,2)-sigma_2p2h(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_2p2h(2:,1)
       end if
       close(10)
    end if

    Open(10,File='neutrino_total_Xsection_multiplicities_gen0.dat',position='append')
    if(numberofcalls.ne.1) backspace(10)
    if(numberOfCalls.gt.1) then
       write(10,'(300E13.5)') raiseFlagVariable,sigma_gen0(2:,1)/float(numberOfCalls), &
            & sqrt(max(0.,((sigma_gen0(2:,2)-sigma_gen0(2:,1)**2/float(numberOfCalls)) &
            & /float(numberOfCalls-1)/float(numberOfCalls))))
    else
       write(10,'(300E13.5)') raiseFlagVariable,sigma_gen0(2:,1)
    end if
    close(10)

    Open(10,File='neutrino_total_Xsection_multiplicities_gen1.dat',position='append')
    if(numberofcalls.ne.1) backspace(10)
    if(numberOfCalls.gt.1) then
       write(10,'(300E13.5)') raiseFlagVariable,sigma_gen1(2:,1)/float(numberOfCalls), &
            & sqrt(max(0.,((sigma_gen1(2:,2)-sigma_gen1(2:,1)**2/float(numberOfCalls)) &
            & /float(numberOfCalls-1)/float(numberOfCalls))))
    else
       write(10,'(300E13.5)') raiseFlagVariable,sigma_gen1(2:,1)
    end if
    close(10)

    Open(10,File='neutrino_total_Xsection_multiplicities_gen2.dat',position='append')
    if(numberofcalls.ne.1) backspace(10)
    if(numberOfCalls.gt.1) then
       write(10,'(300E13.5)') raiseFlagVariable,sigma_gen2(2:,1)/float(numberOfCalls), &
            & sqrt(max(0.,((sigma_gen2(2:,2)-sigma_gen2(2:,1)**2/float(numberOfCalls)) &
            & /float(numberOfCalls-1)/float(numberOfCalls))))
    else
       write(10,'(300E13.5)') raiseFlagVariable,sigma_gen2(2:,1)
    end if
    close(10)

    Open(10,File='neutrino_total_Xsection_multiplicities_gen3ormore.dat',position='append')
    if(numberofcalls.ne.1) backspace(10)
    if(numberOfCalls.gt.1) then
       write(10,'(300E13.5)') raiseFlagVariable,sigma_gen3ormore(2:,1)/float(numberOfCalls), &
            & sqrt(max(0.,((sigma_gen3ormore(2:,2)-sigma_gen3ormore(2:,1)**2/float(numberOfCalls)) &
            & /float(numberOfCalls-1)/float(numberOfCalls))))
    else
       write(10,'(300E13.5)') raiseFlagVariable,sigma_gen3ormore(2:,1)
    end if
    close(10)
    ...
    if(ZeroPion_analysis) then
       call event_sigma_0pions(events,sigma_0pions,initHists,numberOfCalls,identifier=raiseFlagVariable)
       if(includeQE) call event_sigma_0pions(events_QE,sigma_QE_0pions,initHists,numberOfCalls,identifier=raiseFlagVariable)
       if(includeDELTA) call event_sigma_0pions(events_Delta,sigma_Delta_0pions,initHists, &
                                  & numberOfCalls,identifier=raiseFlagVariable)
       if(includeRES) call event_sigma_0pions(events_highRES,sigma_highRES_0pions,initHists,&
                                  & numberOfCalls,identifier=raiseFlagVariable)
       if(includeDIS) call event_sigma_0pions(events_DIS,sigma_DIS_0pions,initHists,numberOfCalls,identifier=raiseFlagVariable)
       if(include1pi) call event_sigma_0pions(events_1piBG,sigma_1piBG_0pions,initHists, &
                                  & numberOfCalls,identifier=raiseFlagVariable)
       if(include2pi) call event_sigma_0pions(events_2piBG,sigma_2piBG_0pions,initHists,&
                                  & numberOfCalls,identifier=raiseFlagVariable)
       if(include2p2hQE .or. include2p2hDelta) &
                 & call event_sigma_0pions(events_2p2h,sigma_2p2h_0pions,initHists,numberOfCalls,identifier=raiseFlagVariable)

       Open(10,File='neutrino_0pions.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_0pions(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_0pions(2:,2)-sigma_0pions(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_0pions(2:,1)
       end if
       close(10)

       if(includeQE) then
       Open(10,File='neutrino_0pions_QE.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_QE_0pions(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_QE_0pions(2:,2)-sigma_QE_0pions(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_QE_0pions(2:,1)
       end if
       close(10)
       end if

       if(includeDELTA) then
       Open(10,File='neutrino_0pions_Delta.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_Delta_0pions(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_Delta_0pions(2:,2)-sigma_Delta_0pions(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_Delta_0pions(2:,1)
       end if
       close(10)
       end if

       if(includeRES) then
       Open(10,File='neutrino_0pions_highRES.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_highRES_0pions(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_highRES_0pions(2:,2)-sigma_highRES_0pions(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_highRES_0pions(2:,1)
       end if
       close(10)
       end if
       ...
       if(include1pi) then
       Open(10,File='neutrino_0pions_1piBG.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_1piBG_0pions(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_1piBG_0pions(2:,2)-sigma_1piBG_0pions(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_1piBG_0pions(2:,1)
       end if
       close(10)
       end if
       ...
       if(include2pi) then
       Open(10,File='neutrino_0pions_2piBG.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_2piBG_0pions(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_2piBG_0pions(2:,2)-sigma_2piBG_0pions(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_2piBG_0pions(2:,1)
       end if
       close(10)
       end if
       ...
       if(includeDIS) then
       Open(10,File='neutrino_0pions_DIS.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_DIS_0pions(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_DIS_0pions(2:,2)-sigma_DIS_0pions(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_DIS_0pions(2:,1)
       end if
       close(10)
       end if

       if(include2p2hQE .or. include2p2hDelta) then
       Open(10,File='neutrino_0pions_2p2h.dat',position='append')
       if(numberofcalls.ne.1) backspace(10)
       if(numberOfCalls.gt.1) then
          write(10,'(300E13.5)') raiseFlagVariable,sigma_2p2h_0pions(2:,1)/float(numberOfCalls), &
               & sqrt(max(0.,((sigma_2p2h_0pions(2:,2)-sigma_2p2h_0pions(2:,1)**2/float(numberOfCalls)) &
               & /float(numberOfCalls-1)/float(numberOfCalls))))
       else
          write(10,'(300E13.5)') raiseFlagVariable,sigma_2p2h_0pions(2:,1)
       end if
       close(10)
       end if
    ...
    if(calorimetric_analysis) then
       call event_hadronicEnergy(events,numin,numax,nubin,Ehad_versusNu_hist, dSigdNu_hist, dSigdEhad_hist, &
    ...
    !*************************************************************************
    !****o* neutrinoAnalysis/diff_XXX_dSigma_dEkin_HADRON_charge_CHARGE.dat
    ! NAME
    ...
    ! (one HADRON of a given CHARGE and no HADRONs of different charges)
    !
    ! Units:
    ...
    !*************************************************************************
    !****o* neutrinoAnalysis/diff_XXX_dSigma_dEkin_HADRON_charge_CHARGE_1X.dat
    ! NAME
    ...
    !*************************************************************************
    !****o* neutrinoAnalysis/diff_XXX_dSigma_dEkin_HADRON_charge_CHARGE_2X.dat
    ! NAME
    ...
    !*************************************************************************
    !****o* neutrinoAnalysis/diff_XXX_dSigma_dEkin_HADRON_charge_CHARGE_MULTI.dat
    ! NAME
    ...
    !*************************************************************************
    !****o* neutrinoAnalysis/diff_XXX_dSigma_dEcostheta_HADRON_charge_CHARGE.dat
    ! NAME
    ...
    !*****************************************************************************
    !****o* neutrinoAnalysis/diff_XXX_dSigma_dTheta_HADRON_charge_CHARGE.dat
    ! NAME
    ...
    if(detailed_diff_output) then
       ...
       if (includeQE) then
          ...
          call event_dSigma_dEcostheta(events_QE,EcosthetaMin,EcosthetaMax,dEcostheta,'diff_QE_'// &
               & trim(intToChar(numberofFinals)),numberOfCalls,dEcostheta_hists_QE,dcostheta_hists_QE,&
               & dEcostheta_hists_QE_MULTI,dcostheta_hists_QE_MULTI,initHists,sameFileNameIn=.true.)
       end if
       ...
       if (includeDELTA) then
          ...
          call event_dSigma_dOmega(events_Delta,dTheta,dPhi,&
               & 'diff_Delta_'//trim(intToChar(numberofFinals)),numberOfCalls,  &
               & dTheta_hists_Delta, dPhi_hists_Delta, dOmega_hists_Delta,initHists,sameFileNameIn=.true.)
          call event_dSigma_dEcostheta(events_Delta,EcosthetaMin,EcosthetaMax,dEcostheta,'diff_Delta_'// &
               & trim(intToChar(numberofFinals)),numberOfCalls,dEcostheta_hists_Delta,dcostheta_hists_Delta,&
               & dEcostheta_hists_Delta_MULTI,dcostheta_hists_Delta_MULTI,initHists,sameFileNameIn=.true.)
       end if

       if (includeRES) then
          call event_dSigma_dE(events_highRES,EkinMin,EkinMax,dEkin,&
               & 'diff_highRES_'//trim(intToChar(numberofFinals)),numberOfCalls,&
               & dE_hists_highRES,initHists,sameFileNameIn=.true., histsMulti=dE_hists_highRES_Multi,&
               & hists1X=dE_hists_highRES_1X,hists2X=dE_hists_highRES_2X)
          call event_dSigma_dOmega(events_highRES,dTheta,dPhi,&
               & 'diff_highRES_'//trim(intToChar(numberofFinals)),numberOfCalls,&
               & dTheta_hists_highRES, dPhi_hists_highRES, dOmega_hists_highRES,initHists,sameFileNameIn=.true.)
          call event_dSigma_dEcostheta(events_highRES,EcosthetaMin,EcosthetaMax,dEcostheta,'diff_highRES_'// &
               & trim(intToChar(numberofFinals)),numberOfCalls,dEcostheta_hists_highRES,dcostheta_hists_highRES,&
               & dEcostheta_hists_highRES_MULTI,dcostheta_hists_highRES_MULTI,initHists,sameFileNameIn=.true.)
       end if

       if (include1pi) then
          call event_dSigma_dE(events_1piBG,EkinMin,EkinMax,dEkin,&
               & 'diff_1piBG_'//trim(intToChar(numberofFinals)),&
               & numberOfCalls,dE_hists_1piBG,initHists,sameFileNameIn=.true., histsMulti=dE_hists_1piBG_Multi,&
               & hists1X=dE_hists_1piBG_1X,hists2X=dE_hists_1piBG_2X)
          call event_dSigma_dOmega(events_1piBG,dTheta,dPhi,'diff_1piBG_'//trim(intToChar(numberofFinals)), &
               & numberOfCalls,dTheta_hists_1piBG, dPhi_hists_1piBG, dOmega_hists_1piBG,initHists,sameFileNameIn=.true.)
          call event_dSigma_dEcostheta(events_1piBG,EcosthetaMin,EcosthetaMax,dEcostheta,'diff_1piBG_'// &
               & trim(intToChar(numberofFinals)),numberOfCalls,dEcostheta_hists_1piBG,dcostheta_hists_1piBG,&
               & dEcostheta_hists_1piBG_MULTI,dcostheta_hists_1piBG_MULTI,initHists,sameFileNameIn=.true.)
       end if

       if (include2pi) then
          call event_dSigma_dE(events_2piBG,EkinMin,EkinMax,dEkin,&
               & 'diff_2piBG_'//trim(intToChar(numberofFinals)),&
               & numberOfCalls,dE_hists_2piBG,initHists,sameFileNameIn=.true., histsMulti=dE_hists_2piBG_Multi,&
               & hists1X=dE_hists_2piBG_1X,hists2X=dE_hists_2piBG_2X)
          call event_dSigma_dOmega(events_2piBG,dTheta,dPhi,'diff_2piBG_'//trim(intToChar(numberofFinals)), &
               & numberOfCalls,dTheta_hists_2piBG, dPhi_hists_2piBG, dOmega_hists_2piBG,initHists,sameFileNameIn=.true.)
          call event_dSigma_dEcostheta(events_2piBG,EcosthetaMin,EcosthetaMax,dEcostheta,'diff_2piBG_'// &
               & trim(intToChar(numberofFinals)),numberOfCalls,dEcostheta_hists_2piBG,dcostheta_hists_2piBG,&
               & dEcostheta_hists_2piBG_MULTI,dcostheta_hists_2piBG_MULTI,initHists,sameFileNameIn=.true.)
       end if

       if (includeDIS) then
          call event_dSigma_dE(events_DIS,EkinMin,EkinMax,dEkin,&
               & 'diff_DIS_'//trim(intToChar(numberofFinals)), &
               & numberOfCalls,dE_hists_DIS,initHists,sameFileNameIn=.true., histsMulti=dE_hists_DIS_Multi,&
               & hists1X=dE_hists_DIS_1X,hists2X=dE_hists_DIS_2X)
          call event_dSigma_dEcostheta(events_DIS,EcosthetaMin,EcosthetaMax,dEcostheta,'diff_DIS_'// &
               & trim(intToChar(numberofFinals)),numberOfCalls,dEcostheta_hists_DIS,dcostheta_hists_DIS,&
               & dEcostheta_hists_DIS_MULTI,dcostheta_hists_DIS_MULTI,initHists,sameFileNameIn=.true.)
       end if
       ...
       if (include2p2hQE .or. include2p2hDelta) then
          call event_dSigma_dE(events_2p2h,EkinMin,EkinMax,dEkin,&
               ...
               & numberOfCalls,dE_hists_2p2h,initHists,sameFileNameIn=.true., histsMulti=dE_hists_2p2h_Multi,&
       ...
       call event_dSigma_dE(events_gen0,EkinMin,EkinMax,dEkin,&
            ...
            & numberOfCalls,dE_hists_gen0,initHists,sameFileNameIn=.true., histsMulti=dE_hists_gen0_Multi,&
            & hists1X=dE_hists_gen0_1X,hists2X=dE_hists_gen0_2X)
       call event_dSigma_dOmega(events_gen0,dTheta,dPhi,'diff_gen0_'//trim(intToChar(numberofFinals)), &
            & numberOfCalls,dTheta_hists_gen0, dPhi_hists_gen0, dOmega_hists_gen0,initHists,sameFileNameIn=.true.)
       call event_dSigma_dEcostheta(events_gen0,EcosthetaMin,EcosthetaMax,dEcostheta,'diff_gen0_'// &
            & trim(intToChar(numberofFinals)),numberOfCalls,dEcostheta_hists_gen0,dcostheta_hists_gen0,&
            & dEcostheta_hists_gen0_MULTI,dcostheta_hists_gen0_MULTI,initHists,sameFileNameIn=.true.)
    end if
        ...
        do m=1, max_speEvent
          ...
          do iHist=0, 0
            ...
            call event_dSigma_dLeptonVariables(events,EkinMin,EkinMax,dEkin, &
                  ...
                  & dEnu_hist(m,iHist), dElepton_hist(m,iHist), dcoslepton_hist(m,iHist), dQ2lepton_hist(m,iHist), &
    ...
    if (outputEvents) then
       ...
       ! PURPOSE
       ! The file shows the outgoing particles.
       ! It is enabled by the switch 'outputEvents'.
       !
       ! Columns:
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do m=1, max_speEvent
          ...
          if (IfPass_SpecificEvent(m,events(j))) then
              select case (m)
              case(1) ! events with 0 pions,
                   Q2rec=MiniBooNE_recQs(lep_mom)           !MiniBooNE QE-like reconstruction
                   Enurec=MiniBooNE_recEnergy(lep_mom)
              ...
              case(3,4) ! events with 1 pi+,  the same for 1pi0
                   Q2rec=MiniBooNE_recQs_Delta(lep_mom)         ! MiniBooNE  energy reconstruction assuming Delta
                   Enurec=MiniBooNE_recEnergy_Delta(lep_mom)

              case(5,6) ! events with at least 1 pi0 (as K2K),   the same for at least 1pi+
                   Q2rec=K2K_recQs(lep_mom,1.483)               ! K2K  energy reconstruction assuming DIS with W=1.483
                   Enurec=K2K_recEnergy(lep_mom,1.483)

              case default
              end select


              call AddHist(H_Q2_real(m,0),H_Q2_real(m,K2Hist(prod_id)), Q2real,perweight/float(num_runs_sameEnergy))
              call AddHist(H_Q2_rec(m,0), H_Q2_rec(m,K2Hist(prod_id)),  Q2rec, perweight/float(num_runs_sameEnergy))

              if (nuEXP>0) call AddHist(H_enu_real(m,0),H_enu_real(m,K2Hist(prod_id)), &
                                                                 & Enureal,perweight/float(num_runs_sameEnergy))
              call AddHist(H_enu_rec(m,0), H_enu_rec(m,K2Hist(prod_id)),  Enurec, perweight/float(num_runs_sameEnergy))
              ...
              if (nuEXP>0) call AddHist2D(H_enu_rec_versus_real(m,0),H_enu_rec_versus_real(m,K2Hist(prod_id)), &
              ...
              if (OSC(nuEXP)) then
                  ...
                  call AddHist(Oscmueantimax_enu_real(m,0),Oscmueantimax_enu_real(m,K2Hist(prod_id)), &
                                                          & Enureal,Posc_mue_antimax*perweight/float(num_runs_sameEnergy))
                  call AddHist(Oscmueantimax_enu_rec(m,0), Oscmueantimax_enu_rec(m,K2Hist(prod_id)),  &
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do iHist=0, max_Hist
       ...
       call writeHist(H_Q2_real(m,iHist), file='reconstruction_Q2real_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       call writeHist(H_Q2_rec(m,iHist),  file='reconstruction_Q2rec_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       if (nuEXP>0) call writeHist(H_enu_real(m,iHist), &
                           & file='reconstruction_Enureal_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       call writeHist(H_enu_rec(m,iHist), file='reconstruction_Enurec_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       call writeHist2D_Gnuplot(H_Q2_rec_versus_real(m,iHist), &
                      & file='reconstruction_Q2_rec_versus_real_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       if (nuEXP>0)  call writeHist2D_Gnuplot(H_enu_rec_versus_real(m,iHist), &
                      & file='reconstruction_Enu_rec_versus_real_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
    end do ! iHist
    end do ! m
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    do iHist=0, max_Hist
       ...
       call writeHist(Oscmumu_enu_rec(m,iHist), &
                    & file='oscillations_mumu_rec_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       call writeHist(Oscmuemax_enu_real(m,iHist), &
                    & file='oscillations_mue_max_real_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       call writeHist(Oscmuemax_enu_rec(m,iHist), &
                    & file='oscillations_mue_max_rec_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       call writeHist(Oscmue_enu_real(m,iHist), &
                    & file='oscillations_mue_real_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       call writeHist(Oscmue_enu_rec(m,iHist), &
                    & file='oscillations_mue_rec_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       call writeHist(Oscmueantimax_enu_real(m,iHist), &
                    & file='oscillations_mue_antimax_real_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
       call writeHist(Oscmueantimax_enu_rec(m,iHist), &
                    & file='oscillations_mue_antimax_rec_'//trim(filename1)//"."//trim(intToChar(iHist))//'.dat')
   ...
   !
   ! The file shows the event distribution (flux-folded xsec) versus true
   ...
   !
   ! PURPOSE
   ! The file shows the xsec versus reconstructed neutrino energy
   ! (see arXiv:1208.3678 [nucl-th]) for a specific final state
   !
   ...
   !
   ! The file shows the 2-D density of the xsec
   ...
   ! (see arXiv:1208.3678 [nucl-th])
   !
   ! The file shows the dsi/dQ^2 xsec versus reconstructed Q2 for a specific
   ! final state
   !
   ! Units:
   ! * For eventtype=5 and process_ID=CC and NC: 10^{-38} cm^2/GeV^2
...
!    call neutrinoProdInfo_clear
  ...
  logical function bound(part)
    ...
    if(kineticEnergy(part)+potential_LRF(part).lt.0) bound=.true.

    if(absVec(part%position).lt.radialScale*NucRadius) bound=.true.

    !if flag "inclusiveAnalysis" is set to true, we take all particles as "unbound"
    if(inclusiveAnalysis) bound=.false.

  end function bound


  logical function below_threshold(part)
    use particleDefinition
    ...
    if(part%id.eq.1.and.(part%momentum(0)-part%mass).lt.kineticEnergyDetectionThreshold_nucleon) below_threshold=.true.

    !kinetic energy threshold for charged pions
    if(part%id.eq.101.and.part%charge.ne.0.and.(part%momentum(0)-part%mass).lt.kineticEnergyDetectionThreshold_chargedpion) &
         & below_threshold=.true.

    !kinetic energy threshold for neutral pions
    if(part%id.eq.101.and.part%charge.eq.0.and.(part%momentum(0)-part%mass).lt.kineticEnergyDetectionThreshold_neutralpion) &
         & below_threshold=.true.
  ...
  real, intent(in)  :: L ! distance (km) from the near to the far detector !735 MINOS (Soudan Mine),  250 K2K, 0.541 MiniBooNE (from source to near)
  real, optional, intent(in) :: deltaCP ! CP violating phase
  real, intent(out) :: Posc_mumu, Posc_mue, Posc_mue_max,Posc_mue_antimax

  !! parameters take from arXiv:1203.4090[hep-ex] Bishai, Diwan, ... "Neutrino Oscillations in the Precision Era"
  ...
  real, parameter :: sin_theta23=0.70710678, cos_theta23=0.70710678, sin_2theta13 = 0.316, cos_theta13 = 0.987
  real, parameter :: deltaM2_21 = 7.6e-5, sin_2theta12 = 0.927    !! theta12=34grad
  real :: deltaM2_31, sin_deltaCP, Posc_mutau
  ...
  Posc_mue = sin_theta23**2 * sin_2theta13**2 * (sin(1.267*deltaM2_31*L/Enu))**2 &
       ...
       &        * ( sin_deltaCP * sin(1.267*deltaM2_31*L/Enu) + sqrt(1.-sin_deltaCP**2) * cos(1.267*deltaM2_31*L/Enu) )
