...
contains
  ...
  subroutine DoElementaryAnalysis (realparticles, finalFlag)
    ...
    use twoBodyTools, only : MomentumTransfer2,IsChargeExchange
    ...
    Ensemble_loop : do i = 1,numensembles
       ...
       PANDA2 : if (DoPanda) then
          ...
          if (numOmega==1) then
             ...
             ! A+B --> \Omega^-
             sigma_OmegaBaryon = sigma_OmegaBaryon + 1.
    ...
    if(finalFlag) then
       ...
       PANDA4 : if (DoPanda) then
          ...
          write(31,'(10e13.6)') ekin_lab, p_lab, srts, sigma_total, sigma_elastic, & 
               ...
               & sigma_I0LL,sigma_I1SL
          close(31)
          
          !Xi-production in ppBar collisions:
          open(31,file='Panda2.dat',position='append') !p pBar --> Xi XiBar(+X)
          ...
          open(31,file='Panda3.dat',position='append') 
          ...
          write(31,'(11e13.6)') ekin_lab, p_lab, srts, sigma_OmegaBaryon
          close(31)
