...
PUBLIC
  ...
  ! unit conversion
  real, parameter :: hbarc = 0.197326968
  real, parameter :: GeVSquared_times_mb = 0.1*hbarc**(-2)    ! = GeV**2 mb = 2.568 = 1/0.389
  ...
  ! particle masses:
  ! leptons
  real, parameter :: melec = 0.00051099892                    ! electron mass in GeV
  real, parameter :: mmuon = 0.105658369                      ! muon mass in GeV
  real, parameter :: mtau  = 1.77699                          ! tau mass in GeV
  ! hadrons
